    ...
    <footer className="bg-green-800 text-white py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4">M.T.R.E. Giardinaggio</h3>
            <p className="text-green-200 mb-4">
              {t('footer.address.street')}<br />
              {t('footer.address.city')}<br />
              <a href="tel:+41767426736" className="text-green-200 hover:text-white transition-colors">
                {t('footer.address.phone')}
              </a><br />
              <a href="mailto:emanuele.novara77@gmail.com" className="text-green-200 hover:text-white transition-colors">
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/18Gu23c6qq/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                  <svg className="w-6 h-6 text-green-200 hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
